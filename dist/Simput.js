	        ...
	        render: function render() {
	            function listamatize(el, index) {
	                return _react2.default.createElement(
	                    'li',
	                    { key: index, onClick: setupSimput, name: el },
	                    el
	                );
	            }
	    ...
	    getJSON(url, function (error, data) {
	        ...
	        if (data.input) {
	            ...
	            script.onload = function () {
	                ...
	                _reactDom2.default.render(_react2.default.createElement(_Simput2.default, { data: data.data, model: module.model }), container);
	            };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ViewMenu = __webpack_require__(162);
	...
	exports.default = _react2.default.createClass({
	    ...
	    render: function render() {
	        return _react2.default.createElement(
	            'div',
	            { className: 'Simput' },
	            _react2.default.createElement(_ViewMenu2.default, { data: this.props.data, model: this.props.model, onChange: this.updateActive }),
	...
	exports.default = _react2.default.createClass({
	    ...
	    addView: function addView(viewId) {
	        var viewList = this.props.data.data[viewId] || [],
	            ...
	            name = this.props.model.views[viewId].label + ' ' + index;
	    ...
	    activateSection: function activateSection(viewId, index) {
	        ...
	        if (viewList.length <= index) {
	            viewList.push({ name: this.props.model.views[viewId].label });
	            this.props.data.data[viewId] = viewList;
	        }
	        this.setState({ viewId: viewId, index: index });
	    ...
	    render: function render() {
	        ...
	        return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                'ul',
	                null,
	                this.props.model.order.map(function (viewId) {
	                    ...
	                    return _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _this.props.model.views[viewId].label
	                        ),
	                        ...
	                        _react2.default.createElement(
	                            'ul',
	                            { style: { display: hasSubList && viewSize !== undefined ? '' : 'none' } },
	                            viewList.map(function (viewData, idx) {
	                                return _react2.default.createElement(
	                                    'li',
	                                    { key: 'view-' + viewId + '-' + idx,
	                                        style: { fontWeight: viewId === _this.state.viewId && idx === _this.state.index ? 'bold' : 'normal' } },
	                                    _react2.default.createElement(
	                                        'span',
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            children.map(function (subViewId) {
	                                return _react2.default.createElement(
	                                    'li',
	                                    ...
	                                    _react2.default.createElement(
	                                        'span',
	                                        { onClick: _this.activateSection.bind(_this, subViewId, 0) },
	                                        _this.props.model.views[viewId].label
	                                    )
	                                );
	                            })
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".ViewMenu {\n    width: 50%;\n}", ""]);
