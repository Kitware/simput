...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["Simput"] = __webpack_require__(1);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Simput = __webpack_require__(161);

	var _Simput2 = _interopRequireDefault(_Simput);

	var _Labels = __webpack_require__(205);

	var _Labels2 = _interopRequireDefault(_Labels);

	var _network = __webpack_require__(202);
	...
	function setupSimput(event) {
	    ...
	    createViewer('/type/' + event.target.getAttribute('name') + '.js', function () {
	        console.log('new!');
	    });
	}

	function setupChoices(choices) {
	    var Choices = _react2.default.createClass({
	        displayName: 'Choices',
	        propTypes: {
	        ...
	        render: function render() {
	            function listamatize(el, index) {
	                return _react2.default.createElement(
	                    'li',
	                    { style: { cursor: 'pointer' }, key: index, onClick: setupSimput, name: el },
	                    el
	                );
	            }
	    ...
	    _reactDom2.default.render(_react2.default.createElement(Choices, { choices: choices }), container);
	}

	function createViewer(url, callback) {
	    var lang = 'en';
	    (0, _network.getJSON)(url, function (error, data) {
	        if (error) {
	        ...
	        if (data.input) {
	            var scriptToLoad = '/type/' + data.data.type + '.js';
	            ...
	            script.onload = function () {
	                var module = Simput.types[data.data.type],
	                    labels = new _Labels2.default(module, lang),
	                    // <= FIXME pick the right language // --lang
	                help = {},
	                    // FIXME too,
	                ...
	                _reactDom2.default.render(_react2.default.createElement(_Simput2.default, { data: data.data, model: module.model, labels: labels, help: help, convert: convert }), container);
	            };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ViewMenu = __webpack_require__(191);

	var _ViewMenu2 = _interopRequireDefault(_ViewMenu);

	var _modelGenerator = __webpack_require__(194);
	...
	exports.default = _react2.default.createClass({
	    ...
	    propTypes: {
	        ...
	        convert: _react2.default.PropTypes.func
	    },
	    ...
	    convertModel: function convertModel() {
	        ...
	        var results = this.props.convert(this.props.data);

	        if (!results.error) {
	            console.log('posting', results.results);
	            (0, _network.postJSON)('/data', results.results, function (error, data) {
	                if (error) {
	    ...
	    downloadFile: function downloadFile(contents) {
	    ...
	    updateActive: function updateActive(viewId, index) {
	        var data = (0, _modelGenerator2.default)(this.props.model, this.props.data, viewId, index, this.props.labels.activeLabels.attributes, this.props.help),
	            viewData = this.props.data.data[viewId][index];
	        this.setState({ data: data, viewData: viewData });
	    },
	    updateViewData: function updateViewData(newData) {
	    ...
	    render: function render() {
	        return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                'div',
	                { className: 'Simput__Content' },
	                _react2.default.createElement(_ViewMenu2.default, { data: this.props.data,
	...
	exports.default = _react2.default.createClass({
	    ...
	    render: function render() {
	        ...
	        var viewData = this.props.viewData,
	            ...
	            return (0, _Factory2.default)(content, viewData, _this.valueChange);
	        },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Cell2 = __webpack_require__(164);

	var _Cell3 = _interopRequireDefault(_Cell2);

	var _Checkbox2 = __webpack_require__(177);

	var _Checkbox3 = _interopRequireDefault(_Checkbox2);

	var _Enum2 = __webpack_require__(181);
	...
	var _Slider2 = __webpack_require__(184);
	...
	var factoryMapping = {
	    Cell: function Cell(prop, viewData, onChange) {
	        return _react2.default.createElement(_Cell3.default, { key: prop.data.id, data: prop.data, ui: prop.ui, viewData: viewData, show: prop.show, onChange: onChange });
	    },
	    Slider: function Slider(prop, viewData, onChange) {
	        return _react2.default.createElement(_Slider3.default, { key: prop.data.id, data: prop.data, ui: prop.ui, viewData: viewData, show: prop.show, onChange: onChange });
	    },
	    Enum: function Enum(prop, viewData, onChange) {
	        return _react2.default.createElement(_Enum3.default, { key: prop.data.id, data: prop.data, ui: prop.ui, viewData: viewData, show: prop.show, onChange: onChange });
	    },
	    Checkbox: function Checkbox(prop, viewData, onChange) {
	        return _react2.default.createElement(_Checkbox3.default, { key: prop.data.id, data: prop.data, ui: prop.ui, viewData: viewData, show: prop.show, onChange: onChange });
	    }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BlockMixin = __webpack_require__(165);

	var _BlockMixin2 = _interopRequireDefault(_BlockMixin);

	var _Layouts = __webpack_require__(166);
	...
	var _ToggleIconButton = __webpack_require__(170);

	var _ToggleIconButton2 = _interopRequireDefault(_ToggleIconButton);
	...
	exports.default = _react2.default.createClass({
	    ...
	    render: function render() {
	        return _react2.default.createElement(
	            'div',
	            { className: "InputBlock " + (this.props.show(this.props.viewData) ? '' : 'is-hidden') },
	            _react2.default.createElement(
	                'div',
	                { className: 'InputBlock_header' },
	                _react2.default.createElement(
	                    'strong',
	                    null,
	                    this.props.ui.label
	                ...
	                _react2.default.createElement(
	                    'span',
	                    null,
	                    _react2.default.createElement(_ToggleIconButton2.default, { icon: 'fa-question-circle',
	            ...
	            _react2.default.createElement('div', { className: 'InputBlock_help-box ' + (this.state.helpOpen ? '' : 'is-hidden'),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _InputCell = __webpack_require__(167);
	...
	var layouts = {
	    ...
	    '2x3': function x3(data, ui, callback) {
	        ...
	        return [_react2.default.createElement(
	            'tr',
	            { className: 'Input_row', key: data.id + '_0' },
	            _react2.default.createElement(_InputCell2.default, { idx: 0, label: ui.componentLabels[0], type: ui.type, value: data.value[0], name: data.name, domain: ui.domain, onChange: callback }),
	            _react2.default.createElement(_InputCell2.default, { idx: 1, label: ui.componentLabels[1], type: ui.type, value: data.value[1], name: data.name, domain: ui.domain, onChange: callback }),
	            _react2.default.createElement(_InputCell2.default, { idx: 2, label: ui.componentLabels[2], type: ui.type, value: data.value[2], name: data.name, domain: ui.domain, onChange: callback })
	        ), _react2.default.createElement(
	            'tr',
	            { className: 'Input_row', key: data.id + '_1' },
	    ...
	    '3x2': function x2(data, ui, callback) {
	        ...
	        return [_react2.default.createElement(
	            ...
	            'tr',
	            { className: 'Input_row', key: data.id + '_2' },
	            _react2.default.createElement(_InputCell2.default, { idx: 4, label: ui.componentLabels[4], type: ui.type, value: data.value[4], name: data.name, domain: ui.domain, onChange: callback }),
	            _react2.default.createElement(_InputCell2.default, { idx: 5, label: ui.componentLabels[5], type: ui.type, value: data.value[5], name: data.name, domain: ui.domain, onChange: callback })
	        )];
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _convert = __webpack_require__(168);

	var _convert2 = _interopRequireDefault(_convert);

	var _validate = __webpack_require__(169);
	...
	exports.default = _react2.default.createClass({
	    ...
	    render: function render() {
	        return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                'label',
	                { className: 'InputCell_label' },
	                this.props.label
	            ),
	            _react2.default.createElement('input', { className: 'InputCell_input',
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../../../../css-loader/index.js!./../../../../../../../../node_modules/autoprefixer-loader/index.js?browsers=last 2 version!./style.css", function() {
				var newContent = require("!!./../../../../../css-loader/index.js!./../../../../../../../../node_modules/autoprefixer-loader/index.js?browsers=last 2 version!./style.css");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".ToggleIconButton {\n    cursor: pointer;\n}\n\n.ToggleIconButton.is-enabled {\n    color: black;\n}\n\n.ToggleIconButton.is-disabled {\n    color: grey;\n}\n\n\n@media screen and (max-width: 400px),\nscreen and (orientation: landscape) and (max-device-width: 400px) {\n\n    i.ToggleIconButton {\n        font-size: 1.4em;\n        height: 1.5em;\n    }\n\n}\n\n.is-ios-device i.ToggleIconButton {\n    font-size: 1.4em;\n    height: 1.5em;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "label.Checkbox_label {\n  min-height: 16px;\n  padding: 2px 6px 0;\n  font-size: 0.75em;\n  color: #aaa;\n}", ""]);
	    ...
	    render: function render() {
	        ...
	        return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'select',
	                    { className: 'Enum__Prop', value: multiple ? this.props.data.value : this.props.data.value[0], defaultValue: null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".Enum__Prop {\n\tmargin-top: 6px;\n\twidth: 100%;\n}", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(3),
	    BlockMixin = __webpack_require__(165),
	    Slider = __webpack_require__(185),
	    ToggleIconButton = __webpack_require__(170);
	        ...
	        var mapper = function mapper() {
	            if (Array.isArray(_this.props.data.value)) {
	                ...
	                for (var i = 0; i < _this.props.data.value.length; i++) {
	                    ...
	                    ret.push(React.createElement(Slider, { value: _this.props.data.value[i],
	            ...
	            return React.createElement(Slider, { value: _this.props.data.value,
	                min: _this.props.ui.domain.min,
	                max: _this.props.ui.domain.max,
	                step: step,
	                onChange: _this.valueChange });
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    'span',
	                    null,
	                    React.createElement(ToggleIconButton, { icon: 'fa-question-circle',
	                        value: this.state.helpOpen,
	                        toggle: !!this.props.ui.help,
	                        onChange: this.helpToggled })
	                )
	            ...
	            React.createElement('div', { className: 'InputBlock_help-box ' + (this.state.helpOpen ? '' : 'is-hidden'),
	                dangerouslySetInnerHTML: { __html: this.props.ui.help } })
	        );
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(3),
	    NumberSliderControl = __webpack_require__(186);
	...
	exports.default = React.createClass({
	    ...
	    render: function render() {
	        ...
	        return React.createElement(NumberSliderControl, _extends({}, propsCopy, {
	            onChange: this.valueChange }));
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".prop-header {\n    border-bottom: 1px solid lightgrey;\n    width: 100%;\n    padding: 10px 8px 3px;\n    font-size: 1.1em;\n}", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _react2.default.createClass({
	    ...
	    render: function render() {
	        ...
	        var fontWeight = function fontWeight(viewId, idx) {
	            return viewId === _this.state.viewId && idx === _this.state.index ? 'bold' : 'normal';
	        };
	        return _react2.default.createElement(
	            'div',
	            { className: 'Outline' },
	            _react2.default.createElement(
	                'ul',
	                null,
	                this.props.model.order.map(function (viewId, idx) {
	                    var viewList = _this.props.data.data[viewId] || [],
	                        hasSubList = _this.props.data.data[viewId] && _this.props.data.data[viewId].length > 0,
	                        viewSize = _this.props.model.views[viewId].size,
	                        children = _this.props.model.views[viewId].children || [];

	                    return _react2.default.createElement(
	                        'li',
	                        { key: 'view-list-' + viewId, style: { fontWeight: fontWeight(viewId, 0) } },
	                        _react2.default.createElement('i', { className: 'fa fa-fw fa-check' }),
	                        _react2.default.createElement(
	                            'span',
	                            { onClick: _this.activateSection.bind(_this, viewId, 0) },
	                            _this.props.labels.getView(viewId)
	                        ),
	                        _react2.default.createElement('i', { className: 'fa fa-fw fa-plus',
	                            style: { display: viewSize === -1 ? 'inline-block' : 'none' },
	                            onClick: _this.addView.bind(_this, viewId) }),
	                        _react2.default.createElement(
	                            'ul',
	                            { style: { display: hasSubList && viewSize !== undefined ? 'block' : 'none' } },
	                            viewList.map(function (viewData, viewIdx) {
	                                return _react2.default.createElement(
	                                    'li',
	                                    { key: 'view-' + viewId + '-' + viewIdx, style: { fontWeight: fontWeight(viewId, viewIdx) } },
	                                    _react2.default.createElement(
	                                        'span',
	                                        { onClick: _this.activateSection.bind(_this, viewId, viewIdx) },
	                                        viewData.name
	                                    ),
	                                    _react2.default.createElement('i', { className: 'fa fa-fw fa-trash', onClick: _this.removeView.bind(_this, viewId, viewIdx) })
	                                );
	                            })
	                        ),
	                        _react2.default.createElement(
	                            'ul',
	                            { style: { display: children.length ? 'block' : 'none' } },
	                            children.map(function (subViewId, subIdx) {
	                                return _react2.default.createElement(
	                                    'li',
	                                    { key: 'sub-view-' + subViewId, style: { fontWeight: fontWeight(subViewId, subIdx) } },
	                                    _react2.default.createElement('i', { className: 'fa fa-fw fa-check' }),
	                                    _react2.default.createElement(
	                                        'span',
	                                        { onClick: _this.activateSection.bind(_this, subViewId, subIdx) },
	                                        _this.props.labels.getView(subViewId)
	                                    )
	                                );
	                            })
	                        )
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".Outline {\n    padding-left: 18px;\n    padding-right: 15px;\n    margin-right: 12px;\n}\n\n.Outline ul {\n    list-style: none;\n}\n\n.Outline > ul {\n\tpadding-left: 0px;\n}\n\n.Outline li {\n    cursor: pointer;\n    max-width: 30vw;\n}", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var showCache = {};
	var parameterCache = {};
	var alwaysShow = function alwaysShow() {
	    return true;
	};
	var uiPropTypeMapping = {
	    checkbox: 'Checkbox',
	    enum: 'Enum'
	};
	...
	function getParameter(model, attrName, paramId) {
	    ...
	    if (!parameterCache[attrName][paramId]) {
	        model.definitions[attrName].parameters.forEach(function (param) {
	...
	function generateUI(parameter, label, help, external, modelExternal) {
	    ...
	    if (parameter.domain && parameter.domain.external) {
	        ...
	        if (external && external[externalKey]) {
	            ...
	            ui.domain = _defineProperty({}, externalKey + ' not found', externalKey + '-not-found');
	        }
	    }
	...
	function getUI(model, attrName, paramId, labels, help, external) {
	    ...
	    if (!uiCache[attrName][paramId]) {
	        ...
	        var newUI = generateUI(getParameter(model, attrName, paramId, external, model.external), uiLabels, uiHelp);
	...
	function getData(model, fullData, selectedViewId, viewIdx, attrName, parameterId, external) {
	    ...
	    var containerData = fullData[selectedViewId][viewIdx];
	    ...
	    if (!containerData[attrName][parameterId]) {
	        ...
	        if (paramDef.default) {
	            ...
	            if (external && external[paramDef.domain.external]) {
	                ...
	                externalObj = _defineProperty({}, paramDef.domain.external + ' not found', paramDef.domain.external + '-not-found');
	            }

	            var val = externalObj[Object.keys(externalObj)[0]];

	            containerData[attrName][parameterId] = {
	                id: attrName + '.' + parameterId,
	                value: [].concat((0, _clone2.default)(val))
	            };
	        } else if (paramDef.domain) {
	            var val = paramDef.domain[Object.keys(paramDef.domain)[0]];
	            containerData[attrName][parameterId] = {
	                id: attrName + '.' + parameterId,
	                value: [].concat((0, _clone2.default)(val))
	            };
	...
	function getParameterData(model, input, selectedViewId, viewIdx, attrName, parameterId, labels, help) {
	    var ui = getUI(model, attrName, parameterId, labels, help, input.external),
	        data = getData(model, input.data, selectedViewId, viewIdx, attrName, parameterId, input.external);

	    return { ui: ui, data: data, show: alwaysShow };
	}
	...
	function getShowFunction(model, attrName, orAttr) {
	    ...
	    if (!showCache[attrName][orAttr]) {
	        (function () {
	            var attrList = [attrName].concat(Object.keys(model.definitions[attrName].children)),
	...
	function generateDataModel(model, input, selectedViewId, viewIdx, labels, help) {
	    var propertyList = [],
	    ...
	    viewAttrs.forEach(function (attrName) {
	        var attr = { title: labels[attrName].title },
	            contents = [];
	        model.definitions[attrName].parameters.forEach(function (paramAttr, idx) {
	            if (Array.isArray(paramAttr)) {
	                //OR prop
	                paramAttr.forEach(function (orAttr) {
	                    model.definitions[orAttr].parameters.forEach(function (param) {
	                        var prop = getParameterData(model, input, selectedViewId, viewIdx, orAttr, param.id, labels, help);
	                ...
	                var prop = getParameterData(model, input, selectedViewId, viewIdx, attrName, paramAttr.id, labels, help);
	                prop.viewData = viewData;
	                if (paramAttr.show) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(196), __webpack_require__(197), __webpack_require__(198)], __WEBPACK_AMD_DEFINE_RESULT__ = function (kindOf, isPlainObject, mixIn) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(199)], __WEBPACK_AMD_DEFINE_RESULT__ = function(forOwn){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(200), __webpack_require__(201)], __WEBPACK_AMD_DEFINE_RESULT__ = function (hasOwn, forIn) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(200)], __WEBPACK_AMD_DEFINE_RESULT__ = function (hasOwn) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../../../node_modules/autoprefixer-loader/index.js?browsers=last 2 version!./styles.css", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../../../node_modules/autoprefixer-loader/index.js?browsers=last 2 version!./styles.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".Simput-header {\n    padding: 8px;\n    border-bottom: 1px solid grey;\n    display: -webkit-flex;\n    display: -ms-flexbox;\n    display: flex;\n    -webkit-justify-content: space-between;\n        -ms-flex-pack: justify;\n            justify-content: space-between;\n    -webkit-align-items: center;\n        -ms-flex-align: center;\n            align-items: center;\n}\n\n.Simput-header > span {\n    font-weight: bold;\n    font-size: 25px;\n    padding-left: 10px;\n}\n\n.Simput-header button {\n    margin: 0 5px;\n    width: 100px;\n    padding: 9px 0 7px;\n    background-color: white;\n    border: 1px solid lightgrey;\n    border-radius: 3px;\n}\n\n.Simput-header button span {\n    margin-right: 8px;\n}\n\n.Simput__Content {\n    display: -webkit-flex;\n    display: -ms-flexbox;\n    display: flex;\n    flex-order: row;\n    -webkit-justify-content: flex-start;\n        -ms-flex-pack: start;\n            justify-content: flex-start;\n}\n\n.Outline {\n    -webkit-flex: none;\n        -ms-flex: none;\n            flex: none;\n}\n\n.Outline + .property-panel {\n    -webkit-flex: 1;\n        -ms-flex: 1;\n            flex: 1;\n}", ""]);
...
/***/ function(module, exports) {
	...
	var Labels = (function () {
	    function Labels(module) {
	        var defaultLang = arguments.length <= 1 || arguments[1] === undefined ? 'en' : arguments[1];
	    ...
	    _createClass(Labels, [{
	        ...
	        key: 'getParameter',
	        value: function getParameter(attributeName, parameterId) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../css-loader/index.js!./../../../../../node_modules/autoprefixer-loader/index.js?browsers=last 2 version!./font-awesome.css", function() {
				var newContent = require("!!./../../css-loader/index.js!./../../../../../node_modules/autoprefixer-loader/index.js?browsers=last 2 version!./font-awesome.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../css-loader/index.js!./../../../../node_modules/autoprefixer-loader/index.js?browsers=last 2 version!./normalize.css", function() {
				var newContent = require("!!./../css-loader/index.js!./../../../../node_modules/autoprefixer-loader/index.js?browsers=last 2 version!./normalize.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../css-loader/index.js!./../../../../../../node_modules/autoprefixer-loader/index.js?browsers=last 2 version!./state.css", function() {
				var newContent = require("!!./../../../css-loader/index.js!./../../../../../../node_modules/autoprefixer-loader/index.js?browsers=last 2 version!./state.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".is-hidden { display: none; }\n\n.is-clickable { cursor: pointer; };\n", ""]);
