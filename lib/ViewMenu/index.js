        ...
        return (<div className='Outline'>
                    ...
                    { this.props.model.order.map( viewId => {
                        ...
                        return <li key={ 'view-list-' + viewId }>
                            ...
                            <span onClick={ this.activateSection.bind(this, viewId, 0) }>{ this.props.model.views[viewId].label }</span>
                            ...
                            { children.map( subViewId => {
                                return <li key={ 'sub-view-' + subViewId }>
                                    <i className='fa fa-fw fa-check'></i>
                                    <span onClick={ this.activateSection.bind(this, subViewId, 0) }>{ this.props.model.views[viewId].label }</span>
                                </li>;
                            })}
                            </ul>
                        </li>;
