...
export default React.createClass({
    ...
    render() {
        const isActive = (viewId, idx) => (viewId === this.state.viewId && idx === this.state.index) ? true : false;

        return (<div className={ [this.props.className, style.container].join(' ')}>
                    ...
                    { this.props.model.order.map( (viewId, idx) => {
                        ...
                        return (
                            ...
                            <i  className={ viewSize === -1 ? style.addButton : style.hidden }
